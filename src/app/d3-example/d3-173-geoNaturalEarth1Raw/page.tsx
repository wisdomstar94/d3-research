...
import { select, geoNaturalEarth1Raw, json, geoPath, geoProjection } from 'd3';
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-173-geoNaturalEarth1Raw</title>
        <meta name="description" content="d3-173-geoNaturalEarth1Raw 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
     ...
     */
    // const projection = geoProjection(geoNaturalEarth1Raw())
