"use client"
import { arc, ascending, chord, ribbon, select } from "d3";
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-341-ribbon</title>
        <meta name="description" content="d3-341-ribbon 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.ribbon 함수는 기본 설정으로 새 리본 생성기를 만듭니다.
    */
