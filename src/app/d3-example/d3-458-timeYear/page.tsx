...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-458-timeYear</title>
        <meta name="description" content="d3-458-timeYear 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.timeYear 함수는 날짜 이전이거나 같은 최신 간격 경계 날짜를 나타내는 새 날짜를 반환합니다. 
    ...
    */
    console.log(`timeYear(new Date())`, timeYear(new Date()));
  }, []);
