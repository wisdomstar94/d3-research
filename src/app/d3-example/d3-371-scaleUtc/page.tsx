...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-371-scaleUtc</title>
        <meta name="description" content="d3-371-scaleUtc 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.scaleUtc 함수는 지정된 범위, 기본 보간기 및 클램핑이 비활성화된 
      UTC(Coordinated Universal Time)를 사용하여 새 시간 척도를 구성합니다. 
      도메인의 기본값은 [2000-01-01, 2000-01-02]입니다. 
      ...
      범위 요소와 출력 요소 유형이 다른 경우 척도와 함께 사용되는 보간기 공장에서 
      이 동작과 일치해야 하며 보간된 범위 요소를 해당 출력 요소로 변환해야 합니다.
