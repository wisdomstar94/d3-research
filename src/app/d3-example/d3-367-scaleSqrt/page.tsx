...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-367-scaleSqrt</title>
        <meta name="description" content="d3-367-scaleSqrt 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.scaleSqrt 함수는 지정된 범위, 지수 0.5, 기본 보간기 및 
      클램핑이 비활성화된 새 연속 전력 척도를 구성합니다. 
      도메인의 기본값은 [0, 1]입니다. 
      범위를 지정하지 않으면 기본값은 [0, 1]입니다. 
      이 방법은 d3.scalePow().exponent(0.5)에 해당하는 편의 방법입니다.
