...
import { geoConicConformalRaw, select, json, geoPath, geoProjection } from "d3";

// https://runebook.dev/ko/docs/d3/d3-geo-projection
// https://devdocs.io/d3/
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-152-geoConicConformalRaw</title>
        <meta name="description" content="d3-152-geoConicConformalRaw 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.geoConicConformalRaw 함수는 원뿔형 등각 투영..
    */
    ...
    const projection = geoProjection(geoConicConformalRaw(0, 0))
      .scale(80)
      .rotate([0, 0])
      .center([0, 0])
