...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-433-timeMillisecond</title>
        <meta name="description" content="d3-433-timeMillisecond 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.timeMillisecond 함수는 날짜 이전이거나 같은 최신 간격 경계 날짜를 나타내는 새 날짜를 반환합니다. 
    ...
    */
    console.log(`timeMillisecond(new Date())`, timeMillisecond(new Date()));
  }, []);
