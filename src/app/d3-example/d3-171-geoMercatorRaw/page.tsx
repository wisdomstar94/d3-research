...
import { select, geoMercatorRaw, json, geoPath, geoProjection } from 'd3';
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-171-geoMercatorRaw</title>
        <meta name="description" content="d3-171-geoMercatorRaw 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
     ...
     */
    // const projection = geoProjection(geoMercatorRaw())
