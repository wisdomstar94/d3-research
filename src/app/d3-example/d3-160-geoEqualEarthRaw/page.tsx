...
import { select, json, geoPath, geoEqualEarthRaw, geoProjection } from "d3";
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-160-geoEqualEarthRaw</title>
        <meta name="description" content="d3-160-geoEqualEarthRaw 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /**
     * 구조상으론 맞는 것 같으나 project is not a function 에러가 발생함.
     */
    console.log('geoEqualEarthRaw()', geoEqualEarthRaw());
    // const projection = geoProjection(geoEqualEarthRaw())
