...
import { select, chordTranspose, ascending, arc, ribbon } from 'd3';
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-032-chordTranspose</title>
        <meta name="description" content="d3-032-chordTranspose 예시 코드 페이지입니다." />
