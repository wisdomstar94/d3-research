"use client"
import { interpolateYlGn, scaleDivergingSqrt, select } from "d3";
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-349-scaleDivergingSqrt</title>
        <meta name="description" content="d3-349-scaleDivergingSqrt 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.scaleDivergingSqrt 함수는 d3.scaleSqrt와 유사한 제곱근 변환을 갖는 발산 척도.

      제1 제네릭은 인터폴레이터 리턴 타입의 데이터 타입에 대응한다. 
      두 번째 제네릭은 알 수 없는 값의 데이터 유형에 해당한다.
    */
    const fn = scaleDivergingSqrt(interpolateYlGn);
