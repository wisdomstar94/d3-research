...
import { area, curveCatmullRom, line, select } from 'd3';
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-060-curveCatmullRom</title>
        <meta name="description" content="d3-060-curveCatmullRom 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    */
    ...
    /* Area */
    const areaGenerator = area<ID3CurveCatmullRom.Data>()
      .x((d) => d.x)
      .y1((d) => 50)
      .y0((d) => d.y)
    ...
    /* Line */
    const lineGenerator = line<ID3CurveCatmullRom.Data>()
      .x((d) => d.x)
      .y((d) => d.y)
      .curve(curveCatmullRom)
    ;
