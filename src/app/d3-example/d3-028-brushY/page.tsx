...
import { select, brushY, D3BrushEvent } from 'd3';
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-028-brushY</title>
        <meta name="description" content="d3-028-brushY 예시 코드 페이지입니다." />
  ...
  useEffect(() => {
    ...
    */
    ...
    select(boxElementRef.current)
      ...
      .append("g")
      .attr("class", "brush")
      .call(brushY().on("brush", (e: D3BrushEvent<any>) => {
        console.log('e', e);
      }));
  }, []);
