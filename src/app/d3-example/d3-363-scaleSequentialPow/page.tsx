"use client"
import { scaleSequentialPow } from "d3";
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-363-scaleSequentialPow</title>
        <meta name="description" content="d3-363-scaleSequentialPow 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.scaleSequentialPow 함수는 검정력 척도와 유사한 지수 변환이 있는 순차 척도입니다.
