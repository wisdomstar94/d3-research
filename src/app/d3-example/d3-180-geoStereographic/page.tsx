...
import { select, json, geoPath, geoStereographic } from "d3";
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-180-geoStereographic</title>
        <meta name="description" content="d3-180-geoStereographic 예시 코드 페이지입니다." />
