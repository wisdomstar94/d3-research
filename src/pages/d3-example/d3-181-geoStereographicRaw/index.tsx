...
import { select, json, geoPath, geoStereographicRaw, geoProjection } from "d3";
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-181-geoStereographicRaw</title>
        <meta name="description" content="d3-181-geoStereographicRaw 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
     ...
     */
    // const projection = geoProjection(geoStereographicRaw())
