...
import { select, geoOrthographicRaw, json, geoPath, geoProjection } from 'd3';
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-175-geoOrthographicRaw</title>
        <meta name="description" content="d3-175-geoOrthographicRaw 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
     ...
     */
    // const projection = geoProjection(geoOrthographicRaw())
