...
import { geoConicEqualAreaRaw, select, json, geoPath, geoProjection } from "d3";

const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-154-geoConicEqualAreaRaw</title>
        <meta name="description" content="d3-154-geoConicEqualAreaRaw 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.geoConicEqualArea 함수는 원시 알버스의 등면적 원뿔 투영입니다.
    */
    ...
    const projection = geoProjection(geoConicEqualAreaRaw(0, 0))
      .scale(80)
      .rotate([0, 0])
      .center([0, 0])
