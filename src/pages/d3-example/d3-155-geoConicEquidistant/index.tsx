...
import { geoConicEquidistant, select, json, geoPath } from "d3";

// https://www.geeksforgeeks.org/d3-js-geoconicequidistant-function/

const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-155-geoConicEquidistant</title>
        <meta name="description" content="d3-155-geoConicEquidistant 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.geoConicEquidistant 함수는 주어진 지오존슨 데이터에서 코닉 등거리 투영을 그리는 데 사용됩니다.
    */
