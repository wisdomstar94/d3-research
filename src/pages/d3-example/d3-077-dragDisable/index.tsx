...
import { dragDisable, select, drag } from 'd3';
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-077-dragDisable</title>
        <meta name="description" content="d3-077-dragDisable 예시 코드 페이지입니다." />
...
const PageContents = () => {
  ...
  useEffect(() => {
    ...
    /*
      d3.dragDisable 은 지정된 창에서 기본 끌어서 놓기 및 텍스트 선택을 금지합니다.
    */
  ...
  return (
    <>
      ...
      텍스트 드래그가 안될 겁니다. (그러나 위에 빨간 사각형을 드래그하고 나면 드래그가 됩니다.)
    </>
  );
};
