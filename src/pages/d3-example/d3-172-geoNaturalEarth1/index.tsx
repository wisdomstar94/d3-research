...
import { select, geoNaturalEarth1, json, geoPath } from 'd3';
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-172-geoNaturalEarth1</title>
        <meta name="description" content="d3-172-geoNaturalEarth1 예시 코드 페이지입니다." />
