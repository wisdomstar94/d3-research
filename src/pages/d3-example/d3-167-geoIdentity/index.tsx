...
import { select, json, geoPath, geoAzimuthalEqualArea, geoIdentity } from "d3";
...
const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-167-geoIdentity</title>
        <meta name="description" content="d3-167-geoIdentity 예시 코드 페이지입니다." />
