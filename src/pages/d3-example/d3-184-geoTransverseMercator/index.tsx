...
import { select, json, geoPath, geoTransverseMercator } from "d3";

// https://www.geeksforgeeks.org/d3-js-geotransversemercator-function/

const Index: NextPage = () => {
  return (
    <>
      <Head>
        <title>d3-184-geoTransverseMercator</title>
        <meta name="description" content="d3-184-geoTransverseMercator 예시 코드 페이지입니다." />
